...
<form method="POST" action="submit_clearance_form.php">
    ...
    <div class="section">
        ...
        <label>IIC Committee Clearance:</label>
        <textarea name="iic_committee_remark" class="form-control" placeholder="Remarks or NA if no dues" required></textarea>

        <label>Samaritans Committee Clearance:</label>
        <textarea name="samaritans_committee_remark" class="form-control" placeholder="Remarks or NA if no dues" required></textarea>

        <label>Samarth Committee Clearance:</label>
        <textarea name="samarth_committee_remark" class="form-control" placeholder="Remarks or NA if no dues" required></textarea>

        <label>Eclectica Committee Clearance:</label>
        <textarea name="eclectica_committee_remark" class="form-control" placeholder="Remarks or NA if no dues" required></textarea>
    </div>
