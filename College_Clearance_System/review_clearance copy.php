...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
            ...
            (($role == 'tech_committee') ? 'tech_committee' :
            (($role == 'iic_committee') ? 'iic_committee' :
            (($role == 'samaritans_committee') ? 'samaritans_committee' :
            (($role == 'samarth_committee') ? 'samarth_committee' :
            'eclectica_committee'))))))))) . "' class='btn btn-primary'>Review</a></td>
        </tr>";
    }
