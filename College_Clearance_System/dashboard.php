...
// --- IMPORTANT: Direct Redirect for 'admin' role ---
if ($role === 'admin') {
...
// Handle AJAX requests for content loading (only for non-admin roles now)
if (isset($_GET['ajax']) && isset($_GET['page'])) {
    ...
    switch ($_GET['page']) {
        ...
        case 'review_clearance_requests':
            ...
            break;
        // The 'manage_users' case is removed here because admin is directly redirected
        default:
...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Set default page based on user role (admin role is handled by PHP redirect)
            if (role === 'student') {
            ...
            // No 'else if (role === 'admin')' here because PHP handles direct redirect for admin
