...
<div class="form-container">
    ...
    <h4>Remarks:</h4>
    <?php foreach (['accounts', 'library', 'department', 'tech_committee', 'cultural_committee', 'sports_committee','iic_committee','samaritans_committee','samarth_committee','eclectica_committee'] as $sect): ?>
