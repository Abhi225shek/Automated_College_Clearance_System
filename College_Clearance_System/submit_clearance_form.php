...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $remarks = [
            ...
            'iic_committee' => mysqli_real_escape_string($conn, $_POST['iic_committee_remark']),
            'samaritans_committee' => mysqli_real_escape_string($conn, $_POST['samaritans_committee_remark']),
            'samarth_committee' => mysqli_real_escape_string($conn, $_POST['samarth_committee_remark']),
            'eclectica_committee' => mysqli_real_escape_string($conn, $_POST['eclectica_committee_remark']),
        ];
